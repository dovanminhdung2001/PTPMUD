...
public class UserService {
    ...
    public static UserEntity find(Integer id) throws SQLException {
        connection = DriverManager.getConnection(url, username, password);
    ...
    public static ArrayList<UserEntity> findAll() throws SQLException {
        connection = DriverManager.getConnection(url, username, password);
    ...
    public static Boolean isLogging (Integer id) throws SQLException {
        connection = DriverManager.getConnection(url, username, password);
